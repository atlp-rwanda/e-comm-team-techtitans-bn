// Cron job to check password expiration in cron.js
...
const EXPIRATION_TIME = process.env.PASSWORD_EXPIRATION_TIME; // in days, it should be stored in environment variable
...
const PasswordReminder= cron.schedule('0 9 0 */30 * *', async () => { // every minute
