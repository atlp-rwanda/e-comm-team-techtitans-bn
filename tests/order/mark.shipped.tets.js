...
describe("sellers will be able to mark an order as shipped", () => {
  ...
  test("changing order status to shipped", async () => {
    ...
    const token =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiZW1haWwiOiJzZWxsZXJAZ21haWwuY29tIiwicm9sZUlkIjoyLCJpYXQiOjE2ODE4MTA4NjAsImV4cCI6NDgzNzU3MDg2MH0.KrM9LIVX1Yh8RBbQbwRqV_HpbOxq-7_sGXICWgmNK28";
