...
productRouter.get('/product/update/stockStatus/2/:id', _authMiddleware.isSeller, _product.outOfStockStatusUpdate);
// 2. Make a product Expired
productRouter.get('/product/update/stockStatus/3/:id', _authMiddleware.isSeller, _product.expiredStatusUpdate);
// 3. Make a product Available
productRouter.get('/product/update/stockStatus/1/:id', _authMiddleware.isSeller, _product.availableStatusUpdate);

// Delete a Product
productRouter.delete('/product/delete/:id', _authMiddleware.isSeller, _product.deleteOneProduct);
