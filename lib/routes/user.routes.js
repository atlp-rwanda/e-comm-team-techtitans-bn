...
// Update user profile
userRouter.put('/:uuid', _checkPassword.default, _profile.default);
...
userRouter.put('/updateAccountStatus/:uuid', _auth.isAdmin, (0, _auth.checkPermission)('manage users'), _disableEnableUsers.default);
