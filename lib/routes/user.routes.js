...
var _CheckupdatedPassword = _interopRequireDefault(require("../middleware/auth/CheckupdatedPassword"));
...
// Update user profile
userRouter.put('/:uuid', _CheckupdatedPassword.default, _profile.default);
