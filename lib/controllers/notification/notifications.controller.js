...
exports.notifyVendorProductOutOfStock = exports.notifyVendorOnProductDeletion = exports.notifyVendorOnProductCreate = exports.notifyVendorOnProductBought = exports.notifyUserOnProductOrderShipped = exports.NotifyVendorsDeletion = exports.ExpiringProducts = void 0;
...
const vendorId = Products.vendorId;
...
const NotifyVendorsDeletion = _nodeCron.default.schedule('* * * * *', async () => {
  try {
    const products = await Products.findAll();
    for (const product of products) {
      ...
      // Check if the product exists before sending notification
...
exports.NotifyVendorsDeletion = NotifyVendorsDeletion;
